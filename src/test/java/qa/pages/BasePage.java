...
// import org.openqa.selenium.remote.RemoteMobileElement;
...
public class BasePage {
    ...
    public void closeApp() {
        //((InteractsWithApps) driver).terminateApp("sg.getgo.booking.uat"); // cek lagi
        ((InteractsWithApps) driver).closeApp();
    }

    public void launchApp() {
        //((InteractsWithApps) driver).activateApp("sg.getgo.booking.uat"); // cek lagi
...
//        scrollObject.put("toVisible", "sdfnjksdnfkld");
    ...
    public boolean find(final MobileElement element, long timeout) {
        try {
    ...
    public boolean find(final By element, long timeout) {
        try {
            WebDriverWait wait = new WebDriverWait(driver, timeout);
            return wait.until(new ExpectedCondition<Boolean>() {
                @Override
